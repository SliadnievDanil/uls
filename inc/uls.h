...
// Macro functions to check file properties
...
// Structure to hold lengths of various fields for formatting
...
void uls_flagless(t_flag *flags);
void scan_directory(int argc, char **argv, t_flag *flags);
